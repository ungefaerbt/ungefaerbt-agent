...
QUELLEN = {
    ...
    "deutschlandfunk.de": {
        ...
        "feeds": [
            ...
            {"ressort": "kultur",       "rss": "https://www.deutschlandfunk.de/kulturportal-100.rss",   "enabled": False},
            ...
            {"ressort": "sport",        "rss": "https://www.deutschlandfunk.de/sportportal-100.rss",    "enabled": False},
        ],
    },
    "mdr.de": {
        "ausrichtung": "Mitte",
    ...
    "spiegel.de": {
        ...
        "feeds": [
            ...
            {"ressort": "kultur",              "rss": "https://www.spiegel.de/kultur/index.rss",                    "enabled": False},
            ...
            {"ressort": "sport",               "rss": "https://www.spiegel.de/sport/index.rss",                     "enabled": False},
        ],
    },
    "zeit.de": {
        "ausrichtung": "Mitte-Links",
        ...
        "feeds": [
            ...
            {"ressort": "sport",        "rss": "https://newsfeed.zeit.de/sport/index",        "enabled": False},
        ],
    },
    "sueddeutsche.de": {
        "ausrichtung": "Links",
        ...
        "feeds": [
            ...
            {"ressort": "kultur",       "rss": "https://rss.sueddeutsche.de/rss/Kultur",       "enabled": False},
            {"ressort": "wissen",       "rss": "https://rss.sueddeutsche.de/rss/Wissen",       "enabled": True},
            {"ressort": "sport",        "rss": "https://rss.sueddeutsche.de/rss/Sport",        "enabled": False},
    ...
    "faz.net": {
        ...
        "feeds": [
            ...
            {"ressort": "finanzen",        "rss": "https://www.faz.net/rss/aktuell/finanzen/",        "enabled": False},
            {"ressort": "feuilleton",      "rss": "https://www.faz.net/rss/aktuell/feuilleton/",      "enabled": False},
            ...
            {"ressort": "sport",           "rss": "https://www.faz.net/rss/aktuell/sport/",           "enabled": False},
        ],
    },
    "welt.de": {
        "ausrichtung": "Rechts",
        ...
        "feeds": [
            ...
            {"ressort": "finanzen",   "rss": "https://www.welt.de/feeds/section/finanzen.rss",   "enabled": False},
            {"ressort": "panorama",   "rss": "https://www.welt.de/feeds/section/panorama.rss",   "enabled": False},
            {"ressort": "sport",      "rss": "https://www.welt.de/feeds/section/sport.rss",      "enabled": False},
            {"ressort": "kultur",     "rss": "https://www.welt.de/feeds/section/kultur.rss",     "enabled": False},
    ...
    "bild.de": {
        ...
        "feeds": [
            ...
            {"ressort": "sport",        "rss": "https://www.bild.de/rss-feeds/rss-16725492,feed=sport.bild.html",        "enabled": False},
    ...
    "stern.de": {
        ...
        "feeds": [
            ...
            {"ressort": "kultur",           "rss": "https://www.stern.de/feed/standard/kultur/",          "enabled": False},
            {"ressort": "sport",            "rss": "https://www.stern.de/feed/standard/sport/",           "enabled": False},
    ...
    "rnd.de": {
        ...
        "feeds": [
            ...
            {"ressort": "sport",              "rss": "https://www.rnd.de/arc/outboundfeeds/rss/category/sport/",               "enabled": False},
            ...
            {"ressort": "kultur",             "rss": "https://www.rnd.de/arc/outboundfeeds/rss/category/kultur/",              "enabled": False},
            {"ressort": "wissen",             "rss": "https://www.rnd.de/arc/outboundfeeds/rss/category/wissen/",              "enabled": True},
            {"ressort": "geld_finanzen",      "rss": "https://www.rnd.de/arc/outboundfeeds/rss/category/geld-finanzen/",       "enabled": False},
    ...
    "taz.de": {
        ...
        "feeds": [
            ...
            {"ressort": "kultur",       "rss": "https://taz.de/Kultur/!p4639;rss/",       "enabled": False},
            {"ressort": "sport",        "rss": "https://taz.de/Sport/!p4646;rss/",        "enabled": False},
    ...
    "handelsblatt.com": {
        ...
        "feeds": [
            ...
            {"ressort": "finanzen",        "rss": "https://feeds.cms.handelsblatt.com/finanzen",        "enabled": False},
    ...
    "focus.de": {
        ...
        "feeds": [
            ...
            {"ressort": "finanzen",   "rss": "https://www.focus.de/finanzen/rss",   "enabled": False},
            ...
            {"ressort": "kultur",     "rss": "https://www.focus.de/kultur/rss",     "enabled": False},
            {"ressort": "sport",      "rss": "https://www.focus.de/sport/rss",      "enabled": False},
    ...
    "n-tv.de": {
        ...
        "feeds": [
            ...
            {"ressort": "sport",        "rss": "https://www.n-tv.de/sport/rss",        "enabled": False},
    ...
    "junge-freiheit.de": {
        ...
        "feeds": [
            ...
            {"ressort": "kultur",     "rss": "https://jungefreiheit.de/kultur/feed/",     "enabled": False},
        ],
    },
    "cicero.de": {
        "ausrichtung": "Rechts",
    ...
    "t3n.de": {
        ...
        "enabled": False,
        "feeds": [
            {"ressort": "allgemein", "rss": "https://t3n.de/rss.xml", "enabled": False},
        ],
    },
    "golem.de": {
        "ausrichtung": "Mitte",
        "enabled": False,
        "feeds": [
            {"ressort": "allgemein", "rss": "https://rss.golem.de/rss.php?feed=RSS2.0",             "enabled": False},
            {"ressort": "security",  "rss": "https://rss.golem.de/rss.php?feed=RSS2.0&ms=security", "enabled": False},
        ],
    },
    ...
    "t-online.de": {
        ...
        "feeds": [
            ...
            {"ressort": "sport",               "rss": "https://www.t-online.de/sport/feed.rss",                "enabled": False},
    ...
    "sportschau.de": {
        ...
        "enabled": False,
        "feeds": [
            {"ressort": "sport", "rss": "https://www.sportschau.de/index~rss2.xml", "enabled": False},
        ],
    },
    # ── REGIONAL ────────────────────────────────────────────────
    "haz.de": {
    ...
    "derstandard.at": {
        ...
        "feeds": [
            ...
            {"ressort": "sport",         "rss": "https://www.derstandard.at/rss/sport",         "enabled": False},
            {"ressort": "panorama",      "rss": "https://www.derstandard.at/rss/panorama",      "enabled": True},
            {"ressort": "kultur",        "rss": "https://www.derstandard.at/rss/kultur",        "enabled": False},
    ...
    "kleinezeitung.at": {
        ...
        "feeds": [
            ...
            {"ressort": "sport",      "rss": "https://www.kleinezeitung.at/rss/sport",      "enabled": False},
            {"ressort": "kultur",     "rss": "https://www.kleinezeitung.at/rss/kultur",     "enabled": False},
        ],
    },
    "kurier.at": {
        "ausrichtung": "Mitte",
        ...
        "feeds": [
            ...
            {"ressort": "finanzen",                  "rss": "https://kurier.at/wirtschaft/finanzen/xml/rssd",                          "enabled": False},
            ...
            {"ressort": "sport",                     "rss": "https://kurier.at/sport/xml/rssd",                                        "enabled": False},
            ...
            {"ressort": "kultur",                    "rss": "https://kurier.at/kultur/xml/rssd",                                       "enabled": False},
    ...
    "orf.at": {
        ...
        "feeds": [
            ...
            {"ressort": "sport",       "rss": "https://rss.orf.at/sport.xml",       "enabled": False},
    ...
    "nzz.ch": {
        ...
        "feeds": [
            ...
            {"ressort": "finanzen",      "rss": "https://www.nzz.ch/finanzen.rss",              "enabled": False},
            ...
            {"ressort": "feuilleton",    "rss": "https://www.nzz.ch/feuilleton.rss",            "enabled": False},
            ...
            {"ressort": "sport",         "rss": "https://www.nzz.ch/sport.rss",                 "enabled": False},
    ...
    "blick.ch": {
        ...
        "feeds": [
            ...
            {"ressort": "sport",      "rss": "https://www.blick.ch/sport/rss.xml",     "enabled": False},
